...
public class Game extends AppCompatActivity {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if(event.getAction() == MotionEvent.ACTION_DOWN){
            if(challengesList.size()>=nbTotalChallenges){
                finish();
                return true;
            }
            boolean newChallengeNotDisplayed = true;
            while(newChallengeNotDisplayed)
            {
                ...
                switch (selectedCategorie){
                    case 0 :
                        ...
                        challengeInt = new Random().nextInt(categorie.length);
                        challengeToDisplay = getString(R.string.choice_start) + categorie[challengeInt];
                    ...
                    case 2 :
                        ...
                        challengeInt = new Random().nextInt(categorie.length);
                        challengeToDisplay =  categorie[challengeInt];
                        challengeToDisplay = playersList.get(new Random().nextInt(playersNumber))+ ", " + challengeToDisplay;
                ...
                Challenge currentChallenge = new Challenge(selectedCategorie, challengeInt);
                if(challengesList.indexOf(currentChallenge)==-1){
                    challengesList.add(currentChallenge);
                    ...
                    newChallengeNotDisplayed =false;
                }
            }
        }
